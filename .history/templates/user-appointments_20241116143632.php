<?php
// Template for displaying user appointments and booking form side by side in a flex layout
...
// Display success message if an appointment has been successfully booked
...
<div class="dx-appointments-container">
    ...
    <div class="appointments-form">
        ...
        <?php
        // Display the booking form using a shortcode
