...
<div class="dx-appointments-container">
            ...
            <?php foreach ($appointments as $appointment) : ?>
                <div class="appointment-item">
                    ...
                    <?php if (!empty($appointment->cab_document_url)) : ?>
                        <p>
                            <a href="<?php echo esc_url($appointment->cab_document_url); ?>" class="btn btn-primary" id="download_report_btn" download>
                                Download Report
                            </a>
                        </p>
                    <?php endif; ?>
    ...
    <div id="appointmentFormModal" class="modal">
        <div class="modal-content">
            ...
            <h3 class="new-booking-title">Book Appointment</h3>
