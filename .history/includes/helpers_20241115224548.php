...
function dx_finalize_booking($order_id) {
    ...
    // Save the booking details to your custom database table
    $wpdb->insert($table_name, [
        ...
        'cab_duration'         => 60,  // Default duration, adjust as needed
        'cab_status'           => 'paid',
        'cab_document_url'     => null,
    ]);

    // Clear session data after finalizing the booking
...
function display_appointment_prices() {
    ...
    $product_ids = [
        'standard' => 123,  // Replace with actual product ID for standard appointment
        'extended' => 124,  // Replace with actual product ID for extended appointment
        'premium'  => 125,  // Replace with actual product ID for premium appointment
    ];
