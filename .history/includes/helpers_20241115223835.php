...
function dx_handle_booking_submission() {
    if (isset($_POST['submit_booking']) && is_user_logged_in()) {
        ...
        // Get WooCommerce product ID based on appointment type
        ...
        // Temporarily save the booking details (use a custom session or meta data)
        $appointment_data = [
            'user_id'       => $user_id,
        ...
        // Save in user session or WordPress transients
